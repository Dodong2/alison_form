...
if(empty($name)) {
 ...
 //updating the table
 $result = mysqli_query($conn, "UPDATE studentdb SET student_name='$name', student_email='$email', student_gender='$gender', student_age='$age', student_course='$course' WHERE id=$id");
...
$result = mysqli_query($conn, "SELECT * FROM studentdb WHERE id=$id");
 ...
 <td><input type="submit" name="update" value="Update"></td>
    ...
    <script>
        function confirmUpdate() {
            const updateConfirm = confirm('aren you sure you want to update?')
            if(updateConfirm) {
